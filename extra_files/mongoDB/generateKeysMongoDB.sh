...
certCN=192.168.0.100
entity=mongoDB
entityName=MongoDB

echo "Generating JKS Keystore..."
keytool -genkeypair -alias "$certCN" -keyalg RSA -keysize 2048 -keystore "$entity".jks -dname "cn=$certCN, ou=My Organization, o=My Organization, l=My City, s=My State, c=My Country" -storepass "$entity" -keypass "$entity" -ext san=dns:localhost -ext san=dns:192.168.0.100
